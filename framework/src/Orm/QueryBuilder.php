...
use Finella\Orm\ModelNotFoundException;
...
final class QueryBuilder
{
    ...
    private function eagerLoad(array $models, array $relations): array
    {
        ...
        foreach ($direct as $name) {
            ...
            if ($relation instanceof \Finella\Orm\Relations\Relation) {
    ...
    private function compileRelationExists(string $relation, ?callable $callback): array
    {
        ...
        if (!$relationObject instanceof \Finella\Orm\Relations\Relation) {
    ...
    private function buildRelationExistsSql(\Finella\Orm\Relations\Relation $relation, ?callable $callback): array
    {
        ...
        if (class_exists($relatedClass)) {
            ...
            if ($instance instanceof \Finella\Orm\Model && method_exists($instance, 'usesSoftDeletes') && $instance->usesSoftDeletes()) {
        ...
        if ($relation instanceof \Finella\Orm\Relations\HasMany || $relation instanceof \Finella\Orm\Relations\HasOne) {
        ...
        if ($relation instanceof \Finella\Orm\Relations\BelongsTo) {
        ...
        if ($relation instanceof \Finella\Orm\Relations\BelongsToMany) {
    ...
    private function buildRelationCountSql(\Finella\Orm\Relations\Relation $relation, ?callable $callback): array
    {
    ...
    private function buildRelationAggregateSql(
        \Finella\Orm\Relations\Relation $relation,
        string $column,
        string $function,
        ?callable $callback
    ): array {
